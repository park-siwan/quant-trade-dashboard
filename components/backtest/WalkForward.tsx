...
import { streamWalkForward, saveRollingParams, type WalkForwardEvent } from '@/lib/api/backtest';
import type { WalkForwardWindow, WalkForwardSummary, WalkForwardStatus } from '@/lib/types';
...
export default function WalkForward() {
  ...
  }, [symbol, timeframe, trainMonths, testMonths, status]);
