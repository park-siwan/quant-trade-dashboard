...
export default function SavedResultsPanel({ onApplyParams }: SavedResultsPanelProps) {
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-zinc-400 border-b border-zinc-700">
                ...
                <th className="text-left py-2 px-2">조건</th>
                <th className="text-left py-2 px-2">RSI</th>
                <th className="text-left py-2 px-2">Pivot</th>
